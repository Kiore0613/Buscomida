...
public class CatRecyclerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewCat = view.findViewById(R.id.rv_category);
    ...
    private void retrofitData() {
        ...
        if (getArguments() != null) {
            String idCat = getArguments().getString(OBJ);
            ...
            Call<List<Restaurant>> call = buscomidaApi.getRestauranteById(idCat);
            ...
            call.enqueue(new Callback<List<Restaurant>>() {
                ...
                public void onResponse(Call<List<Restaurant>> call, Response<List<Restaurant>> response) {
                    ...
                    recyclerViewCat.setAdapter(adapterRecyclerView);
                    recyclerViewCat.addItemDecoration(
                    ...
                    adapterRecyclerView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            it.putExtra(OBJ, restaurantsList.get(recyclerViewCat.getChildAdapterPosition(view)));
